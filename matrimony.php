...
<?php if(UserFunctions::isUserAuthenticated()){$details=ADAO::getUserdetailsById($_SESSION['id']);
  ...
  <tr>
    <td height="75"><?php include("common/search_matrimony.php"); ?></td>
  </tr>
  <tr>
    <td height="10">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td>
        <!--Serach Content_tbl-->
         ...
         <?php include("common/search_matrimony_results.php");?>
