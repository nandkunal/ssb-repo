...
<?php if(UserFunctions::isUserAuthenticated()){ $details=ADAO::getUserdetailsById($_SESSION['id']);	echo '<tr><td><table width="220" height="30" border="0" align="right" cellpadding="0" cellspacing="0">
        <tr>
  ...
  <tr>
    <td height="75"><?php include("common/search_community.php"); ?></td>
  </tr>
  <tr>
    <td height="10">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td>
        <!--Serach Content_tbl-->
         ...
         <?php include("common/search_community_results.php");?>
