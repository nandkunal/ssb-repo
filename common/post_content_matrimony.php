                ...
                <td width="426"><table width="422" border="0" align="left" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="422" height="50" valign="middle"><table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="427"><span class="style7">Post your Profile for Matrimonial Match </span></td>
                        </tr>
                    </table></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td height="400"><form id="ad_form" name="ad_form" method="post" action="post_users_matrimony.php" onsubmit="return checkValidation()"
                      ...
                      <table width="399" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td width="398" height="110" background="images/searchbarbodybgbig.jpg"><table width="380" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="154" height="35">Full Name</td>
                            ...
                            <tr>
                              ...
                              <td height="35">&nbsp;</td>
                              <td height="35">
                              <select name="cat" size="1" id="category" class="selectfield"><option selected="selected" value="0">Select</option><option value="1">Groom</option><option value="2">Bride</option></select>
                            ...
                            <tr>
                              ...
                              <td height="35">&nbsp;</td>
                              <td height="35"><label>
                                <input type="text" name="caste" class="tb7" />
                              </label></td>
                            </tr>
                            <tr>
                              ...
                              <td height="35">&nbsp;</td>
                              <td height="35">
                                <input type="text" name="dob" class="tb7" id="dob" /><img src="images/cal.gif" onClick="javascript:NewCssCal('dob','yyyyMMdd')" style="cursor:pointer"/>
                              </td>
                            </tr>
                            <tr>
                              <td height="35"> Age</td>
                              <td height="35">&nbsp;</td>
                              <td height="35"><label>
                               <input type="text" name="age" class="tb7" />
                              </label></td>
                            </tr>
                              <tr>
                              ...
                              <td height="35">&nbsp;</td>
                              <td height="35"><label>
                                <input type="text" name="height" class="tb7" />
                              </label></td>
                            </tr>
                               <tr>
                              ...
                              <td height="35">&nbsp;</td>
                              <td height="35"><label>
                                <input type="text" name="qual" class="tb7" />
                              </label></td>
                            </tr>
                            <tr>
