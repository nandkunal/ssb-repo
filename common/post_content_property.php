                        ...
                        <tr>
                          ...
                          <td width="398" height="110" background="images/searchbarbodybgbig.jpg"><table width="380" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              ...
                              <td height="35">&nbsp;</td>
                              <td height="35">
                              <select name="property" size="1" id="category" class="selectfield"><option selected="selected" value="0">Select</option><option value="1">Kothi</option><option value="2">Flat</option><option value="3">Plot</option></select>
